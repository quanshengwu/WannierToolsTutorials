...
plt.xlim([-Bshow,Bshow]); plt.xlabel('B (T)',fontsize=20); plt.ylabel('MR (%)',fontsize=20); plt.tight_layout(); plt.savefig('MR.pdf')
...
plt.xlim([-Bshow,Bshow]); plt.xlabel('B (T)',fontsize=20); plt.ylabel(r'$\rho_{xx} (\mu\Omega \rm cm)$',fontsize=20); plt.tight_layout(); plt.savefig('rhoxx.pdf')
...
for i in range(2):
    ...
    plt.plot(B,arr,linewidth=3.5,color=colors[i])
plt.xlim([-Bshow,Bshow]); plt.xlabel('B (T)',fontsize=20);plt.ylabel(r'$\sigma_{xy} (\rm S/\rm cm)$',fontsize=20); plt.tight_layout(); plt.savefig('sigmaxy.pdf')
...
for i in range(2):
    ...
    plt.plot(B,arr,linewidth=3.5,color=colors[i])
plt.xlim([-Bshow,Bshow]); plt.xlabel('B (T)',fontsize=20);plt.ylabel(r'$\rho_{yx} (\mu\Omega \rm cm)$',fontsize=20); plt.tight_layout(); plt.savefig('rhoyx.pdf')
